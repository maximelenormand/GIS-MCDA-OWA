...
# Set order weights values
w=matrix(0,3,(nbcrit+2))              # First column risk, second column tradeoff + associated order weights   
w[1,]=c(0,0,1,rep(0,(nbcrit-1)))      # Low risk and no tradeoff -> (0,0)
w[2,]=c(1,0,rep(0,(nbcrit-1)),1)      # High risk and no tradeoff -> (0,1)
w[3,]=c(0.5,1,rep(1/nbcrit,nbcrit))   # Intermediate risk and full tradeoff -> (0.5,1)
